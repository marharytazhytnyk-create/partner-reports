#!/usr/bin/env python3
"""
MBR — Mavra (Pizza / Azia / Josper Svintuz / Coffee Art)
...
BRANDS_CONFIG = [
    {
        "slug":         "mavra_pizza_zp",
        "title":        "Mavra Pizza — Запоріжжя",
        "emoji":        "🍕",
        "color":        "#E53935",
        "provider_ids": [138974, 194965, 194972, 194976, 194977, 194981,
                         194982, 194984, 194985, 532627, 742632, 922609, 922611],
        "name_strip":   r"Mavra\s+[Pp]izza\s*",
    },
    {
        "slug":         "mavra_pizza_kr",
        "title":        "Mavra Pizza — Кривий Ріг",
        "emoji":        "🍕",
        "color":        "#C62828",
    ...
    },
    {
        ...
        "emoji":        "🌏",
        "color":        "#F57F17",
        "provider_ids": [195164, 195169, 195171, 195174, 262628],
        "name_strip":   r"Mavra\s+Azia\s*",
    },
    {
        "slug":         "josper_zp",
        "title":        "Josper Svintuz — Запоріжжя",
        "emoji":        "🔥",
        "color":        "#2E7D32",
        "provider_ids": [195006, 195007, 195012, 195015, 195019, 195020,
                         195021, 195024, 195025, 197892, 197899, 197909, 922610],
        "name_strip":   r"Josper\s+Svintuz\s*",
    },
    {
        "slug":         "josper_kr",
        "title":        "Josper Svintuz — Кривий Ріг",
        "emoji":        "🔥",
        "color":        "#1B5E20",
        "provider_ids": [195000, 412723],
        "name_strip":   r"Josper\s+Svintuz\s*",
    },
    {
        "slug":         "josper_vn",
        "title":        "Josper Svintuz — Вінниця",
        "emoji":        "🔥",
        "color":        "#33691E",
        "provider_ids": [194993],
        "name_strip":   r"Josper\s+Svintuz\s*",
    ...
    {
        "slug":         "coffee_art",
        "title":        "Coffee Art — Запоріжжя",
        "emoji":        "☕",
        "color":        "#4E342E",
        "provider_ids": [202213, 202215, 202222, 202224, 202225, 202226],
        "name_strip":   r"Coffee\s+Art\s*",
    },
]
...
BRAND_BAR_COLORS = {
    ...
    "mavra_pizza_kr": ["#7f0000","#b71c1c","#c62828","#d32f2f","#e53935","#ef5350","#f44336","#ef9a9a"],
    "mavra_azia":     ["#e65100","#ef6c00","#f57c00","#fb8c00","#ffa726","#ffb74d","#ffcc80","#ffe0b2"],
    "josper_zp":      ["#1b5e20","#2e7d32","#388e3c","#43a047","#4caf50","#66bb6a","#81c784","#a5d6a7"],
    "josper_kr":      ["#194d1e","#256327","#2e7d32","#388e3c","#43a047","#4caf50","#66bb6a","#81c784"],
    "josper_vn":      ["#33691e","#558b2f","#689f38","#7cb342","#8bc34a","#9ccc65","#aed581","#c5e1a5"],
    "coffee_art":     ["#3e2723","#4e342e","#5d4037","#6d4c41","#795548","#8d6e63","#a1887f","#bcaaa4"],
}
MONTH_BAR_COLORS_BELLA = MONTH_BAR_COLORS  # unused alias
...
def build_html(brands_data: list[tuple[dict, dict]]) -> str:
    ...
    for i, (brand, data) in enumerate(brands_data):
        ...
        bar_colors = BRAND_BAR_COLORS.get(brand["slug"], MONTH_BAR_COLORS)
...
<header class="header">
  <div class="header-left">
    ...
    <div class="header-title">
      <h1>MBR · Mavra / Josper Svintuz / Coffee Art</h1>
      <p>Bolt Food &nbsp;·&nbsp; Місячний звіт &nbsp;·&nbsp; Запоріжжя · Кривий Ріг · Вінниця</p>
    </div>
  </div>
...
<div class="footer">
  ...
  <span>Bolt Food MBR</span> &nbsp;·&nbsp; Запоріжжя · Кривий Ріг · Вінниця
</div>
...
def main():
    ...
    print(f"=== MBR Mavra / Josper / Coffee Art [{today}] ===\n")
    ...
    # Also write to output with period in filename for archiving
    # (optional – keeps the latest always as MBR Mavra.html)
